...
if (Encore.isDevServer()) {
    config.devServer.proxy = {
        '/stations': {
            target: 'https://velib-metropole-opendata.smoove.pro/opendata/Velib_Metropole/station_information.json',
            secure: false,
            changeOrigin: true,
            pathRewrite: {'^/stations' : ''}
        },
        '/gh/*': {
            target: 'https://raphaelvigee.github.io/velib-predictor',
            secure: false,
            changeOrigin: true,
            pathRewrite: {'^/gh' : ''}
        }
